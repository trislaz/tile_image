...
class TileSampler:
    ...
    def artificial_biopsie(self, angle, nb_tiles):
        ...
        """
        rotated_mask = rotate(self.mask, angle)
        rotated_dist = rotate(self.dist, angle)
        rotated_infomat = rotate(self.infomat, angle)
        x, y = np.unravel_index(rotated_dist.argmax())
